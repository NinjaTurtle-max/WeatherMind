...
class Settings(BaseSettings):
    ...
    # 분모 946의 출처(**2026-08-14 재실측**: 시드 **1,018**건 − board **52**건 = 비board
    ...
    #      **2026-08-18 재실측** 시드는 **1,018**건이고 board **52**건이며, 이 블록들이
    #      뽑는 풀은 비실황 **998**건이라 실제 비중은 **52/998 = 5.2%**다(8/12에는
    #      46/992 = 4.6%였다 — 승격 3건이 비중을 0.3%p 올렸을 뿐 판단은 그대로다).
    #      일반 블록 9칸에 적용한 기대값은 **0.47** — 상한 2는 사실상 아무것도 막지
    #      않는 값이 돼 있었다.
