 ...
 *               ⚠️ **기울기가 PNG에 구워져 있다** — 원본 대비 시계 방향 20°
 *               (2026-08-18 사용자 지시. 같은 날 반시계 20°였다가 40° 되돌림).
 *               CSS로 돌리지 않는 이유는 정사각 박스에서 모서리가 잘리고
 *               「여백 0」 계약이 깨지기 때문이다. 다시 조정할 일이 있으면
 *               지금 파일을 또 돌리지 말고 **원본에서 순 각도로 한 번에**
 *               뽑을 것 — 두 번 리샘플링하면 잎 가장자리가 흐려진다.
 *
