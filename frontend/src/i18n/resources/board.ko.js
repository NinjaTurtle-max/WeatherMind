...
export default {
  ...
  explore: {
    ...
    satellite: {
      ...
      readEye: '구름이 중심을 고르게 감싸고 가운데가 뚫렸어요 — **눈**이에요. 시어가 약해 기둥이 곧게 서 있다는 뜻이라, 위성 사진만 보고도 잘 발달한 태풍임을 알 수 있어요.',
      readSheared: '구름 방패가 한쪽으로 밀리고 중심이 드러났어요. 위아래 바람이 어긋나 기둥이 기울었다는 뜻이에요 — 실제 위성 판독에서도 이 모양이 **시어가 세다**는 첫 단서예요.',
    },
    common: {
      back: '← 탐구',
      whyTitle: '🤔 왜 그럴까?',
