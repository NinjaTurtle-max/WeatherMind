...
export default {
  ...
  session: {
    ...
    closing: {
      ...
      base: 'Reference forecast {temp}°C · {prob}% rain',
  ...
  duel: {
    ...
    form: {
      ...
      notice: '📡 Reference forecast — high {max}°C · rain {prob}%',
    ...
    aiPred: '🤖 AI caster',
    actual: 'Observed',
    actualValue: 'High {max}°C · rain {prob}%',
    rainShort: 'Rain {prob}%',
    ...
    historyVs: 'Me {mine}°C vs AI {ai}°C',
    settling: 'Settling',
    judge: {
      ...
      step2Seg1: 'Base error of ±{temp}°C temperature · ±{rain}%p rain, multiplied by the grade scale, gives ',
      step2Strong: '±{tempAmp}°C · ±{rainAmp}%p',
