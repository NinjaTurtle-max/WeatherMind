...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMsg(err.detail ?? t('auth.register.failed'));
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-xl flex-col justify-center px-6 py-10">
      <div className="mb-6 text-center">
        ...
        <h1 className="mt-2 text-2xl font-extrabold text-slate-900">{t('auth.register.title')}</h1>
      </div>
