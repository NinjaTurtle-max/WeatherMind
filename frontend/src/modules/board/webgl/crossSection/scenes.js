...
const floodRiskSaturatedInflow = () => [
  ...
  ...flow({ from: [0.660, H(0.11), ZOBJ], dir: [0, -1, 0], travel: 0.075, count: 1, scale: 0.038, color: rgba('#0369a1', 0.9), at: 2, until: 2, speed: 0.6 }),
  ...
  //     투수/불투수 대비를 부쉈다. (색은 아래 ⓕ가 소유한다 — 8차 값 `#0891b2`는
  //     이제 물이 아니라 `FLOOD_WATER`, 즉 **물체를 물들이는 색**이다.)
  ...
  //       `MAX_GROUND = 8` 안이다.
  vol({ x0: 0.335, x1: 1.0, y0: -0.018, y1: 0.002, z0: 0, z1: Z,
    color: rgba('#06b6d4', 1), pattern: 3, at: 3, layer: 'ground' }),
  vol({ x0: 0.52, x1: 1.0, y0: -0.026, y1: 0.004, z0: 0, z1: Z,
  ...
  ...flow({ from: [0.98, H(0.20), 0.12], dir: [-1, -0.05, 0], travel: 0.20, count: 3, scale: 0.052, color: rgba('#075985', 0.98), at: 3, speed: 0.9, spreadZ: 0.05 }),
