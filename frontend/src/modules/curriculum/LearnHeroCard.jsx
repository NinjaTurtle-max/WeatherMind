...
export default function LearnHeroCard({
  ...
  return (
    <div
      ...
      // 세로 여백 `py-5`(20) → **`py-6`(24)**(2026-08-19 사용자 지시 — "세로로
      // 길이 아주 조금만 더"). 카드 257 → 265px.
      ...
      className="rounded-[20px] bg-gradient-to-b from-[#1F3A5F] to-[#16293F] px-[18px] py-6 shadow-[0_2px_10px_rgba(15,23,42,0.18)]"
    >
