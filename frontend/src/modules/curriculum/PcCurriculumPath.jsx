          ...
          >
            <div className="relative w-full" style={{ height: canvasH }}>
              ...
              {nodes.map((n) => {
                ...
                // 아이콘·라벨은 구분해 보여주고, 클릭 차단만 함께 묶는다.
                // 모바일 `UnitNode`와 같은 의미론이어야 한다: 넘기지 않으면 구름 0에서
                // PC만 열려 문항 진입 전 차단(R10-01 S4)이 뷰포트별로 갈라진다.
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`relative flex h-[68px] w-[68px] items-center justify-center rounded-full border-4 border-white text-[26px] transition ${
                        blocked ? 'cursor-not-allowed' : 'hover:brightness-105 active:scale-95'
