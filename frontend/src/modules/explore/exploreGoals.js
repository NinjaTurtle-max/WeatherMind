/**
 * 탐구 목표 — 「변수를 바꿔보며」에 「해냈다」를 붙인다 (MT-25)
 *
 * ⚠️ 이 머리말은 한동안 **MT-24로 잘못 적혀** 있었다(2026-08-18 정정). MT-24는
 * 보드 순차 열림이고(CARRYOVER_R13 §2041), 탐구 시뮬 목표 조건은 MT-25다(§2561 S-5).
 * 라벨이 틀리면 "이미 했나"를 grep으로 확인할 수 없다 — 실제로 한 번 헛돌았다.
 *
 * ─────────────────────────────────────────────────────────────────────────────
